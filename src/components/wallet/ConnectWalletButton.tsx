...
export function ConnectWalletButton({
    ...
    return (
        <button
            onClick={openModal}
            className={`group inline-flex items-center justify-center gap-2 rounded-2xl border border-electric-violet/20 bg-slate-900 dark:bg-white px-5 py-3 font-bold text-white dark:text-near-black shadow-[0_18px_40px_rgba(163,163,163,0.28)] transition-all hover:opacity-90 hover:scale-[1.01] hover:shadow-[0_22px_50px_rgba(163,163,163,0.34)] ${fullWidth ? 'w-full' : ''} ${className}`}
        >
            <Wallet
                size={16}
                className={
