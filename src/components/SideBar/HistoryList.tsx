      ...
      {workspaceHistory.map((item, i) => {
        ...
        return (
          <button 
            ...
            className="group p-3 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 border border-slate-200 dark:border-white/5 hover:border-slate-200 dark:hover:border-white/10 cursor-pointer transition-all bg-slate-100/70 dark:bg-white/[0.02] text-left w-full"
          >
