...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="h-full bg-slate-50 dark:bg-near-black flex flex-col md:flex-row overflow-hidden">
      {/* Settings Sidebar */}
      <div className="w-full md:w-64 bg-white dark:bg-near-black border-b md:border-b-0 md:border-r border-slate-200 dark:border-white/5 p-4 md:p-6 shrink-0">
        <h1 className="text-xl font-bold text-slate-950 dark:text-white mb-6 flex items-center gap-2 px-2">
        ...
        <div className="max-w-3xl space-y-8">
            {activeSection === 'general' && (
                <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div>
                        <h2 className="text-xl font-bold text-slate-950 dark:text-white mb-1">General Settings</h2>
                        <p className="text-slate-500 dark:text-slate-400 text-sm">Configure basic editor behavior and analytics.</p>
                    </div>

                    <div className="bg-white border border-slate-200 dark:bg-dark-indigo-glow dark:border-white/5 rounded-xl p-6 space-y-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">Editor Auto-Save</h3>
                            ...
                            <button
                                ...
                                className={`w-11 h-6 rounded-full transition-colors relative ${settings.autoSave ? 'bg-electric-violet' : 'bg-slate-300 dark:bg-slate-700'}`}
                            >
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">Show Line Numbers</h3>
                            ...
                            <button
                                ...
                                className={`w-11 h-6 rounded-full transition-colors relative ${settings.showLineNumbers ? 'bg-electric-violet' : 'bg-slate-300 dark:bg-slate-700'}`}
                            >
                        ...
                        <div className="flex items-center justify-between border-t border-slate-200 dark:border-white/5 pt-6">
                            <div>
                                <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">Telemetry</h3>
                            ...
                            <button
                                ...
                                className={`w-11 h-6 rounded-full transition-colors relative ${settings.telemetry ? 'bg-electric-violet' : 'bg-slate-300 dark:bg-slate-700'}`}
                            >
                    ...
                    <div className="bg-white border border-slate-200 dark:bg-dark-indigo-glow dark:border-white/5 rounded-xl p-6 space-y-4">
                        <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">Preferred Explorer</h3>
                             ...
                             {['suiscan', 'suiexplorer', 'suivision'].map((exp) => (
                                 <button
                                    ...
                                    className={`px-4 py-3 rounded-lg border text-xs font-bold capitalize transition-all ${
                                        ...
                                        : 'bg-slate-50 border-slate-200 text-slate-500 hover:bg-slate-100 dark:bg-near-black dark:border-white/10 dark:text-slate-400 dark:hover:bg-white/5'
                                    }`}
                                 >
            ...
            {activeSection === 'network' && (
                <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div>
                        <h2 className="text-xl font-bold text-slate-950 dark:text-white mb-1">Network & RPC</h2>
                        <p className="text-slate-500 dark:text-slate-400 text-sm">Manage custom RPC endpoints for each environment.</p>
                    </div>
                    ...
                    <div className="bg-white border border-slate-200 dark:bg-dark-indigo-glow dark:border-white/5 rounded-xl p-6 space-y-6">
                         {ALL_NETWORKS.map((net) => (
                             <div key={net} className="space-y-2">
                                 ...
                                 <input
                                    className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2.5 text-sm text-slate-900 font-mono placeholder:text-slate-400 focus:border-electric-violet outline-none dark:bg-near-black dark:border-white/10 dark:text-white dark:placeholder:text-slate-700"
             ...
             {activeSection === 'appearance' && (
                <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div>
                        <h2 className="text-xl font-bold text-slate-950 dark:text-white mb-1">Appearance</h2>
                        <p className="text-slate-500 dark:text-slate-400 text-sm">Customize the look and feel of the IDE.</p>
                    </div>

                    <div className="bg-white border border-slate-200 dark:bg-dark-indigo-glow dark:border-white/5 rounded-xl p-6 space-y-6">
                        <div className="space-y-3">
                             <h3 className="text-sm font-bold text-slate-800 dark:text-slate-200">Theme Preference</h3>
                             <div className="grid grid-cols-2 gap-4">
                                 <button
                                    onClick={() => appStore.updateSettings({ theme: 'dark' })}
                                    className={`p-4 rounded-xl border flex flex-col items-center gap-2 ${settings.theme === 'dark' ? 'bg-slate-800 border-sui-500 ring-1 ring-electric-violet/50' : 'bg-white border-slate-200 dark:bg-near-black dark:border-white/10 opacity-50'}`}
                                 >
                                     <div className="w-full h-20 bg-dark-indigo-glow rounded-lg border border-white/10 mb-2"></div>
                                     <span className="text-xs font-bold text-slate-950 dark:text-white">Dark Mode</span>
                                 </button>
                                 <button
                                    onClick={() => appStore.updateSettings({ theme: 'light' })}
                                    className={`p-4 rounded-xl border flex flex-col items-center gap-2 ${settings.theme === 'light' ? 'bg-slate-100 border-sui-500 ring-1 ring-electric-violet/50' : 'bg-white border-slate-200 dark:bg-near-black dark:border-white/10 opacity-50'}`}
                                 >
