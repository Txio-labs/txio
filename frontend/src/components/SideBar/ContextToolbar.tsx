    ...
    <div className="px-4 py-4 flex items-center justify-between gap-2 shrink-0 sticky top-0 z-30 bg-white/80 dark:bg-near-black/50 backdrop-blur-md">
      {mode === 'collections' && isFilterOpen ? (
        <input
          ...
          className="min-w-0 flex-1 rounded-lg border border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-white/[0.04] px-2.5 py-1.5 text-[11px] text-slate-700 dark:text-slate-200 outline-none placeholder:text-slate-600 focus:border-electric-violet/60 focus:ring-1 focus:ring-electric-violet/20"
        />
      ) : (
